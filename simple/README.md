...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 927ab814-9eca-4f7b-9cee-d6be5a02c0dc
```

> `927ab814-9eca-4f7b-9cee-d6be5a02c0dc` is the password of the certificate, you can change it to any password you want.
