...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 89ce3895-2af8-437e-a6c9-52bf25714aa2
```

> `89ce3895-2af8-437e-a6c9-52bf25714aa2` is the password of the certificate, you can change it to any password you want.
