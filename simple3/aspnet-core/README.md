...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5e7dc16f-f11f-41f1-9952-03072fcb6c75
```

> `5e7dc16f-f11f-41f1-9952-03072fcb6c75` is the password of the certificate, you can change it to any password you want.
