...
namespace WebApplication1.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public async Task<string> Get(string str)
        {
            ...
            var p= _dataProtectionProvider.CreateProtector("Microsoft.AspNetCore.Authentication.BearerToken")
                .CreateProtector("Identity.Bearer")
                .CreateProtector( "BearerToken");
