...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a2a472b8-076f-46a1-b062-62befd72bb7e
```

> `a2a472b8-076f-46a1-b062-62befd72bb7e` is the password of the certificate, you can change it to any password you want.
