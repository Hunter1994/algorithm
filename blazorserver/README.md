...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 98124525-caf9-435b-814f-8c745609d101
```

> `98124525-caf9-435b-814f-8c745609d101` is the password of the certificate, you can change it to any password you want.
