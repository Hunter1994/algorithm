...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 805e7d5d-4c5e-4bfc-99ca-e28dcbe1c4fa
```

> `805e7d5d-4c5e-4bfc-99ca-e28dcbe1c4fa` is the password of the certificate, you can change it to any password you want.
