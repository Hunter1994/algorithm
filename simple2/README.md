...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7476bd49-c67b-4d9d-8f5e-98d05c9b4d7c
```

> `7476bd49-c67b-4d9d-8f5e-98d05c9b4d7c` is the password of the certificate, you can change it to any password you want.
