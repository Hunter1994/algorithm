...
{
    public abstract class BookAppService_Tests<TStartupModule> : TodoAppApplicationTestBase<TStartupModule>
    ...
    { 
        ...
        public async Task Should_Create_A_Valid_Book()
        {
            ...
            result.Name.ShouldBe("New Tast book 42");
        }
