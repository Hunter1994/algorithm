...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 508e6835-0b75-49d7-b911-01ff5867bd5b
```

> `508e6835-0b75-49d7-b911-01ff5867bd5b` is the password of the certificate, you can change it to any password you want.
